...
class PathFactor(object):
    """
    Given a single tree (iTree object) and a data point x = [x1,x2,...,xn], compute the legth of the path traversed by the point on the tree when it reaches an external node.
